...
class database {
	...
	public function _select()
	{
		...
		$result = $db->getAssoc ( $this->sqlstring );
	...
	public function _getBestellungen()
	{
		...
		foreach ( $result as $daten )
		{
			...
			foreach ( $result as $data )
			{
				$bilder [] = array (
						'id' => $data ['Bild_idBild'],
						'anzahlbilder' => $data ['Anzahl'],
						'papiertyp' => $data ['Preis_Papier_idPapier'],
						'bildformat' => $data ['Preis_Bildformate_idBildformate'] 
				);
			}
