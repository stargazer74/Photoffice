...
class kundenlogin_show_behavior implements showbehavior
{
	...
	public function _show()
	{
		...
		if(false == $form->validate())
		{
			...
			//alle offenen Bestellungen löschen
			$db = new database();
			...
			{
				if ($data['idkunde'] == $_SESSION['benutzerid'] && $data['kundeabgeschlossen'] == false)
				{
					$db->_delete('warenkorb', $data['id']);
				}
			}
