...
require_once('./view/public/logout.php');
require_once('./view/photographer/firmendaten.php');
require_once('./view/photographer/kunden.php');
require_once('./view/photographer/stammdaten.php');
require_once('./view/photographer/fotodaten.php');
require_once('./view/photographer/agb.php');
require_once('./view/photographer/kundenliste.php');
require_once('./view/photographer/neukunde.php');
require_once('./view/photographer/kundendaten.php');
require_once('./view/photographer/kundeaendern.php');
require_once('./view/photographer/bilder.php');
...
require_once('./view/photographer/bestellungabschliessen.php');
